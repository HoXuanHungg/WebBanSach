<?php 
	$so_du_lieu=15; //số sp trên trang
	...
	$tv="select id,ten,gia,hinh_anh,thuoc_the_loai from san_pham order by id desc limit $vtbd,$so_du_lieu";
	$tv_1=mysqli_query($conn,$tv);
	echo "<table>";
