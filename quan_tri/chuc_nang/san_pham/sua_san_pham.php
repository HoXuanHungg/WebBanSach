	...
	<table width="990px" >
		...
		<tr>
			...
			<td >
				...
				<br><br>
				<input type="file" name="hinh_anh" > <!-- tạo hộp chọn ảnh với name là hinh_anh -->
				<input type="hidden" name="ten_anh" value="<?php echo $ten_anh; ?>" > <!-- thẻ ảnh chứa tên ảnh cũ -->
			</td>
		</tr>
		<tr>
			<td >Giá : </td>
		...
		<tr>
			...
			<td>
				<?php
					$a_1="";
					$a_2="";
					if($trang_chu=="co") //ktra nếu sp xuất hiện ở trang chủ thì chọn selected
					{
						$a_2="selected";
					}
				?>
		...
		<tr>
			...
			<td>
				<?php
					$a_1="";
					$a_2="";
					if($noi_bat=="co") //ktra nếu là sp nổi bật thì chọn selected
					{
						$a_2="selected";
					}
				?>
